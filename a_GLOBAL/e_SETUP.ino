...
void setup() {
  ...
  R_2.setCoxaRadMin(radians(-33.5));
  R_2.setCoxaRadMax(radians(33.5));
  R_2.setFemurRadMin(radians(-90));
  R_2.setFemurRadMax(radians(0));
  R_2.setTibiaRadMin(radians(-90));
  R_2.setTibiaRadMax(radians(0));
 
  R_3.setCoxaRadMin(radians(-90));
  R_3.setCoxaRadMax(radians(0));
